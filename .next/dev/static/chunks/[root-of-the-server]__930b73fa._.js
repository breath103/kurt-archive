...
"[project]/src/zen-garden-v2/plain-texture.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createPlainTextureGenerator(renderer, plainSize, tileSize, gravelColorMap) {
    const renderTarget = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["WebGLRenderTarget"](TEXTURE_RESOLUTION, TEXTURE_RESOLUTION, {
    ...
    const material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ShaderMaterial"]({
        ...
        uniforms: {
            ...
            plainSize: {
                value: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector2"](plainSize.x, plainSize.y)
            },
            tileSize: {
                value: tileSize
            },
    ...
    function update(strokes) {
        ...
        for(let i = 0; i < count; i++){
            ...
            if (path.type === "circle") {
                ...
                // Sample the curve
                const curvePoints = path.points.map((p)=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](p.x + position.x, p.y + position.y, 0));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.core.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2d$texture$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden-v2/plain-texture.ts [client] (ecmascript)");
...
class ZenGardenPlain {
    ...
    loadGravelTexture() {
        ...
        loader.load("/textures/gravel/color.jpg", (texture)=>{
            ...
            this.textureGenerator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2d$texture$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["createPlainTextureGenerator"])(this.renderer, {
                x: this._size.x,
                y: this._size.y
            }, TILE_SIZE, texture);
...
class ZenGardenScene {
    ...
    constructor(encoded, renderer){
        ...
        // Plain
        this.plain = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["ZenGardenPlain"](encoded.plain, renderer);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__930b73fa._.js.map