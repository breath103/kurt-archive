...
class ZenGardenPlainMaterial {
    ...
    constructor({ $textureName, $plainSize, $tileSize, $rakes, renderer }){
        this.material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({});
        this.displacementRenderer = new DisplacementRenderer(renderer);
...
// TODO: Implement GPU-based displacement rendering
function renderDisplacement(baseDisplacement, _textureRepeat, _rakes) {
    // For now, just return base displacement
    // Later: render to WebGLRenderTarget combining base + rake heights
...
class ZenGardenScene {
    ...
    constructor(encoded){
        ...
        this.plain = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["ZenGardenPlain"](encoded.plain, $rakes);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbcbb064._.js.map