...
"[project]/src/zen-garden/types.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/zen-garden/ground-texture.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/types.ts [client] (ecmascript)");
;
;
const MAX_ROCKS = 32;
...
function createGroundTextureGenerator(renderer, gravelTextures, ground) {
    ...
    const renderTarget = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["WebGLRenderTarget"](ground.resolution, ground.resolution, {
    ...
    const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["PlaneGeometry"](2, 2);
    ...
    const material = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ShaderMaterial"]({
        ...
        uniforms: {
            ...
            gardenSize: {
                value: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector2"](ground.size.x, ground.size.y)
            },
            tileSize: {
    ...
    const quad = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
    ...
    function update(rocks) {
        ...
        for(let i = 0; i < count; i++){
            const rock = rocks[i];
            const settings = rock.waveSettings ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["DEFAULT_ROCK_WAVE_SETTINGS"];
...
"[project]/src/zen-garden/materials.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const loadTexture = (name)=>{
        return new Promise((resolve, reject)=>{
            loader.load(`${folderPath}/${name}.jpg`, (texture)=>{
                texture.wrapS = texture.wrapT = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["RepeatWrapping"];
                resolve(texture);
            }, undefined, reject);
        });
    };
...
function createGroundMaterial(gravelTextures, combinedTexture, ground) {
    const uniforms = {
        lightDir: {
            value: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](5, 10, 5).normalize()
        },
        cameraPos: {
            value: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"]()
        },
        tileSize: {
            value: ground.tileSize
        },
...
"[project]/src/zen-garden/storage.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/zen-garden/editor.ts [client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$ground$2d$texture$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/ground-texture.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$materials$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/materials.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/storage.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/types.ts [client] (ecmascript)");
;
;
;
...
class ZenGardenEditor {
    ...
    constructor(canvas){
        this.canvas = canvas;
        this.$selectedObjectId = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"](null);
        this.$regenerateTexture = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$Subject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Subject"]();
        this.$objects = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"]([]);
        this.$ambientIntensity = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"](0.4);
        this.$sunIntensity = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"](0.8);
        this.$mode = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"]("normal");
        ...
        this.groundMat = null;
        this.textureLoader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextureLoader"]();
        ...
        this.raycaster = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Raycaster"]();
        this.mouse = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector2"]();
        ...
        // Load garden data
        this.garden = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["loadGarden"])();
        this.$ground = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"](this.garden.ground);
        this.$groundTextureName = this.$ground.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$map$2e$js__$5b$client$5d$__$28$ecmascript$29$__["map"])((g)=>g.textureName), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$distinctUntilChanged$2e$js__$5b$client$5d$__$28$ecmascript$29$__["distinctUntilChanged"])());
        ...
        this.scene.background = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Color"](0x87ceeb);
        ...
        this.controls = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$controls$2f$OrbitControls$2e$js__$5b$client$5d$__$28$ecmascript$29$__["OrbitControls"](this.camera, this.renderer.domElement);
        this.controls.enableDamping = true;
        this.controls.dampingFactor = 0.05;
        this.controls.maxPolarAngle = Math.PI / 2.1;
        // Lighting
        this.arrowHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ArrowHelper"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](0, -1, 0), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](0, 3, 0), 1.5, 0xffaa00, 0.4, 0.2);
        this.scene.add(this.arrowHelper);
        this.ambientLight = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["AmbientLight"](0xffffff, this.$ambientIntensity.value);
        this.scene.add(this.ambientLight);
        this.directionalLight = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, this.$sunIntensity.value);
    ...
    setupSubscriptions() {
        ...
        this.$groundTextureName.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$switchMap$2e$js__$5b$client$5d$__$28$ecmascript$29$__["switchMap"])((name)=>{
            const path = TEXTURE_PATHS[name];
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$observable$2f$from$2e$js__$5b$client$5d$__$28$ecmascript$29$__["from"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$materials$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["loadGravelTextures"])(this.textureLoader, path));
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$tap$2e$js__$5b$client$5d$__$28$ecmascript$29$__["tap"])((textures)=>{
            if (this.disposed) return;
            const ground = this.$ground.value;
            // Dispose old textures
            if (this.gravelTextures) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$materials$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["disposeGravelTextures"])(this.gravelTextures);
            }
            ...
            this.groundTextureGen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$ground$2d$texture$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["createGroundTextureGenerator"])(this.renderer, textures, ground);
            // Create new ground material
            this.groundMat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$materials$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["createGroundMaterial"])(textures, this.groundTextureGen.normalDispTexture.texture, ground);
            ...
            // Create ground mesh
            const segments = 512;
            const groundGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["PlaneGeometry"](ground.size.x, ground.size.y, segments, segments);
            this.groundMesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mesh"](groundGeometry, this.groundMat.material);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$observable$2f$combineLatest$2e$js__$5b$client$5d$__$28$ecmascript$29$__["combineLatest"])([
            this.$regenerateTexture,
            this.$objects
        ]).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$filter$2e$js__$5b$client$5d$__$28$ecmascript$29$__["filter"])(()=>this.groundTextureGen !== null), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$map$2e$js__$5b$client$5d$__$28$ecmascript$29$__["map"])(([, objects])=>objects.filter((o)=>o.type === "rock"))).subscribe((rocks)=>{
            this.groundTextureGen?.update(rocks);
        });
        // When selected object changes, update visual appearance
        this.$selectedObjectId.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$distinctUntilChanged$2e$js__$5b$client$5d$__$28$ecmascript$29$__["distinctUntilChanged"])()).subscribe((selectedId)=>{
        ...
        this.$ambientIntensity.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$distinctUntilChanged$2e$js__$5b$client$5d$__$28$ecmascript$29$__["distinctUntilChanged"])()).subscribe((value)=>{
        ...
        this.$sunIntensity.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$operators$2f$distinctUntilChanged$2e$js__$5b$client$5d$__$28$ecmascript$29$__["distinctUntilChanged"])()).subscribe((value)=>{
    ...
    updateLightPosition() {
        ...
        const lightDir = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](x, this.lightHeight, z).normalize();
        this.arrowHelper.setDirection(lightDir.negate());
        const edgePos = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](x, 3, z).normalize().multiplyScalar(4);
    ...
    createGardenBorder() {
        ...
        const borderMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color: 0x1a1a1a,
            roughness: 0.8
        });
        ...
        borders.forEach(({ size, pos })=>{
            const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BoxGeometry"](...size);
            const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, borderMaterial);
            mesh.position.set(...pos);
            this.scene.add(mesh);
        });
    }
    createRockMesh(rock) {
        const rockGeometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SphereGeometry"](0.3, 8, 6);
        rockGeometry.scale(1, 0.6, 1);
        const rockMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color: 0x666666,
            roughness: 0.9
        });
        const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mesh"](rockGeometry, rockMaterial);
    ...
    createMossPointMeshes(moss) {
        const pointMaterial = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["MeshStandardMaterial"]({
            color: 0xffaa00,
            emissive: 0xffaa00,
            emissiveIntensity: 0.3
        });
        return moss.polygonPath.map((point, index)=>{
            const geometry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["SphereGeometry"](0.1, 8, 8);
            const mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, pointMaterial);
    ...
    animate;
    saveAndRegenerate() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["saveGarden"])(this.garden);
        this.$objects.next([
            ...this.garden.objects
        ]);
        this.$regenerateTexture.next();
...
"[project]/src/zen-garden/texture.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateGroundNormalMapTexture(garden, options = {}) {
    ...
    texture.wrapS = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ClampToEdgeWrapping"];
    texture.wrapT = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["ClampToEdgeWrapping"];
    texture.needsUpdate = true;
    return texture;
}
function generateRockWaveTexture(waveSettings) {
    const settings = waveSettings ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["DEFAULT_ROCK_WAVE_SETTINGS"];
...
"[project]/src/zen-garden/index.ts [client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$editor$2e$ts__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/zen-garden/editor.ts [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$ground$2d$texture$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/ground-texture.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$materials$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/materials.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$storage$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/storage.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$texture$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/texture.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/types.ts [client] (ecmascript)");
;
;
;
...
"[project]/src/zen-garden/editor.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DEFAULT_ROCK_WAVE_SETTINGS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["DEFAULT_ROCK_WAVE_SETTINGS"],
    "ZenGardenEditor",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$editor$2e$ts__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ZenGardenEditor"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$editor$2e$ts__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/zen-garden/editor.ts [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/types.ts [client] (ecmascript)");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$index$2e$ts__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/zen-garden/index.ts [client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$types$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/types.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$editor$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden/editor.ts [client] (ecmascript)");
;
...
function useZenGardenEditor(canvas) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useZenGardenEditor.useEffect": ()=>{
            if (!canvas) return;
            const ed = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2f$editor$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["ZenGardenEditor"](canvas);
            setEditor(ed);
            return ({
                "useZenGardenEditor.useEffect": ()=>ed.dispose()
            })["useZenGardenEditor.useEffect"];
        }
    }["useZenGardenEditor.useEffect"], [
        canvas
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useZenGardenEditor.useEffect": ()=>{
            if (!editor) return;
            const subs = [
                editor.$selectedObjectId.subscribe({
                    "useZenGardenEditor.useEffect": (v)=>setState({
                            "useZenGardenEditor.useEffect": (s)=>({
                                    ...s,
                                    selectedObjectId: v
                                })
                        }["useZenGardenEditor.useEffect"])
                }["useZenGardenEditor.useEffect"]),
                editor.$groundTextureName.subscribe({
                    "useZenGardenEditor.useEffect": (v)=>setState({
                            "useZenGardenEditor.useEffect": (s)=>({
                                    ...s,
                                    textureName: v
                ...
                editor.$ambientIntensity.subscribe({
                    "useZenGardenEditor.useEffect": (v)=>setState({
                            "useZenGardenEditor.useEffect": (s)=>({
                                    ...s,
                                    ambientIntensity: v
            ...
            return ({
                "useZenGardenEditor.useEffect": ()=>subs.forEach({
                        "useZenGardenEditor.useEffect": (s)=>s.unsubscribe()
                    }["useZenGardenEditor.useEffect"])
            })["useZenGardenEditor.useEffect"];
        }
    }["useZenGardenEditor.useEffect"], [
...
_s(useZenGardenEditor, "iDXR4C4DA3iGBIswUF1qCO5jth0=");
...
const ZenGardenPage = ()=>{
    _s1();
    const [canvas, setCanvas] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            ctx && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    ...
                    ctx.selectedObject?.type === "rock" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RockEditor, {
                    ...
                    ctx.selectedObject?.type === "moss" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute right-4 top-4 w-64 rounded-lg bg-white/90 p-4 shadow-lg backdrop-blur",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mb-4 flex items-center justify-between",
...
_s1(ZenGardenPage, "zFbZsEXZsmvQO7UJYKCVv4FmD/I=", false, function() {
    return [
        useZenGardenEditor
    ];
});
...
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "RockEditor");
__turbopack_context__.k.register(_c1, "SettingsPanel");
__turbopack_context__.k.register(_c2, "ZenGardenPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__34ba2487._.js.map