...
class Vector2 extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector2"] {
    ...
    toVector3(y = 0) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](this.x, y, this.y);
    }
    clone() {
        return new Vector2({
            x: this.x,
...
class ZenGardenMoss {
    ...
    constructor(encoded, scene){
        ...
        this.mesh.position.copy(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$vector2$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["Vector2"](encoded.position).toVector3(MOSS_Y));
        scene.add(this.mesh);
    }
    moveOnPlane(delta) {
...
class ZenGardenRock {
    ...
    constructor(encoded, scene){
        ...
        this.mesh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mesh"](geometry, material);
        this.mesh.position.copy(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$vector2$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["Vector2"](encoded.position).toVector3(ROCK_Y));
        scene.add(this.mesh);
    }
    moveOnPlane(delta) {
        this.mesh.position.add(delta.toVector3());
...
class ZenGardenScene {
    ...
    constructor(encoded){
        ...
        const sun = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DirectionalLight"](0xffffff, 1);
    ...
    screenToPlaneCoordinate(screenX, screenY) {
        const mouse = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector2"](screenX, screenY);
        this.raycaster.setFromCamera(mouse, this.camera);
        const plane = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Plane"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Vector3"](0, 1, 0), 0);
...
class ZenGardenEditor {
    ...
    scene;
    canvas;
    $selectedObject = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$esm5$2f$internal$2f$BehaviorSubject$2e$js__$5b$client$5d$__$28$ecmascript$29$__["BehaviorSubject"](null);
    subscriptions = [];
    disposed = false;
    dragging = null;
...
const ZenGardenV2Page = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ZenGardenV2Page.useEffect": ()=>{
            ...
            if (!canvas) return;
            const editor = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$editor$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["ZenGardenEditor"](canvas, {
                objects: [
                    {
                        id: "rock1",
                        type: "rock",
            ...
            return ({
                "ZenGardenV2Page.useEffect": ()=>editor.dispose()
            })["ZenGardenV2Page.useEffect"];
        }
    }["ZenGardenV2Page.useEffect"], []);
...
_s(ZenGardenV2Page, "UJgi7ynoup7eqypjnwyX/s32POg=");
_c = ZenGardenV2Page;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3acef04._.js.map