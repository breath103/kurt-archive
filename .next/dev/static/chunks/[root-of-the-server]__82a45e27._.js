...
function TexturePreview({ value, renderer }) {
    ...
    const image = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TexturePreview.useMemo[image]": ()=>{
...
_s(TexturePreview, "YV4N7IOGrlr/z2C6TFwMI5HQuhU=");
_c = TexturePreview;
var _c;
...
function NodeGraphViewer({ sinkNodes, renderer, onClose }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NodeGraphViewer.useEffect": ()=>{
            ...
            g.forEach({
                "NodeGraphViewer.useEffect": (info)=>{
                    info.inputs.forEach({
                        "NodeGraphViewer.useEffect": (inputInfo)=>{
                            if (inputInfo) {
            ...
            g.forEach({
                "NodeGraphViewer.useEffect": (node)=>{
            ...
            for(let depth = 0; depth <= maxDepth; depth++){
                ...
                const idealY = [];
                nodes.forEach({
                    "NodeGraphViewer.useEffect": (node, i)=>{
                        const outputIds = outputs.get(node.id) ?? [];
                        if (outputIds.length === 0) {
                            idealY.push(i * 220 + 50);
                        } else {
                            const avgY = outputIds.reduce({
                                "NodeGraphViewer.useEffect": (sum, id)=>sum + (pos.get(id)?.y ?? 0)
                            }["NodeGraphViewer.useEffect"], 0) / outputIds.length;
                            idealY.push(avgY);
                        }
                    }
                }["NodeGraphViewer.useEffect"]);
                // Sort nodes by ideal y to preserve relative ordering
                const sorted = nodes.map({
                    "NodeGraphViewer.useEffect.sorted": (n, i)=>({
                            node: n,
                            y: idealY[i]
                        })
                }["NodeGraphViewer.useEffect.sorted"]).sort({
                    "NodeGraphViewer.useEffect.sorted": (a, b)=>a.y - b.y
                }["NodeGraphViewer.useEffect.sorted"]);
                // Spread out: ensure minimum spacing
                sorted.forEach({
                    "NodeGraphViewer.useEffect": (item, i)=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                        ...
                        children: lines.map((line, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
...
_s(NodeGraphViewer, "L9c1yNxrhpEtWx6FkXFI2u06oJA=");
_c = NodeGraphViewer;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82a45e27._.js.map