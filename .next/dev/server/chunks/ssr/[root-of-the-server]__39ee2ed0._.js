...
class Vector2 extends __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Vector2"] {
    ...
    toVector3(y = 0) {
        return new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Vector3"](this.x, y, this.y);
    }
    serialize() {
        return {
            x: this.x,
...
class ZenGardenRock {
    ...
    constructor(encoded, scene){
        ...
        this.mesh = new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Mesh"](geometry, material);
        this.mesh.position.copy(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$vector2$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["Vector2"](encoded.position).toVector3(ROCK_Y));
        scene.add(this.mesh);
    }
    moveOnPlane(delta) {
...
class ZenGardenScene {
    ...
    constructor(encoded){
        ...
        this.objects = new Map(encoded.objects.map((e)=>{
            switch(e.type){
                case "rock":
                    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$rock$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["ZenGardenRock"](e, this.scene);
                case "moss":
                    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$moss$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["ZenGardenMoss"](e, this.scene);
            }
        }).map((o)=>[
                o.id,
                o
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39ee2ed0._.js.map