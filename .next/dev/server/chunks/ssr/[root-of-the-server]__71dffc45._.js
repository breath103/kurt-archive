...
function TexturePreview({ value, renderer }) {
    ...
    const image = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useMemo"])(()=>{
        const img = value.image;
        // Drawable image - use directly
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        ref: setDiv,
        className: "w-[150px] h-[150px] border border-gray-600 bg-gray-800"
    }, void 0, false, {
...
function NodeGraphViewer({ sinkNodes, renderer, onClose }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        setGraph(g);
        // Build reverse map: node → nodes that receive from it
        ...
        const pos = new Map();
        // Assign y positions: start from sinks (depth 0), then propagate backwards
        for(let depth = 0; depth <= maxDepth; depth++){
            const nodes = nodesByDepth.get(depth) ?? [];
            // First pass: compute ideal y based on outputs
            const idealY = [];
            nodes.forEach((node, i)=>{
                const outputIds = outputs.get(node.id) ?? [];
                if (outputIds.length === 0) {
                    idealY.push(i * 220 + 50);
                } else {
                    const avgY = outputIds.reduce((sum, id)=>sum + (pos.get(id)?.y ?? 0), 0) / outputIds.length;
                    idealY.push(avgY);
                }
            });
            // Sort nodes by ideal y to preserve relative ordering
            const sorted = nodes.map((n, i)=>({
                    node: n,
                    y: idealY[i]
                })).sort((a, b)=>a.y - b.y);
            // Spread out: ensure minimum spacing
            sorted.forEach((item, i)=>{
                const minY = i === 0 ? 50 : (pos.get(sorted[i - 1].node.id)?.y ?? 0) + 220;
                const y = Math.max(item.y, minY);
                pos.set(item.node.id, {
                    x: (maxDepth - depth) * 250 + 50,
                    y
                });
            });
        }
    ...
    graph.forEach((info)=>{
        ...
        const toEl = nodeRefs.current.get(info.id);
        if (!toPos || !toEl) return;
        info.inputs.forEach((inputInfo)=>{
            if (!inputInfo) return;
            const fromPos = positions.get(inputInfo.id);
            const fromEl = nodeRefs.current.get(inputInfo.id);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("svg", {
                        ...
                        children: lines.map((line, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("path", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71dffc45._.js.map