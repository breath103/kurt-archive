...
function OutputPreview({ value, renderer }) {
    if (value instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Texture"]) {
...
function NodeGraphViewer({ sinkNodes, renderer, onClose }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        setGraph(g);
        // Initialize positions by depth
        const nodesByDepth = new Map();
        Array.from(g.values()).forEach((node)=>{
        ...
        info.inputs.forEach((inputInfo)=>{
            ...
            lines.push({
                from: {
                    ...
                    y: fromPos.y + fromEl.offsetHeight / 2
                },
                to: {
                    x: toPos.x,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea124556._.js.map