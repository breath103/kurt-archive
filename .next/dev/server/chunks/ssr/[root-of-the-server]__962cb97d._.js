...
class ZenGardenMoss {
    ...
    constructor(encoded, scene){
        ...
        this.mesh.position.copy(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$vector2$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["Vector2"](encoded.position).toVector3(MOSS_Y));
        scene.add(this.mesh);
    }
    moveOnPlane(delta) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__962cb97d._.js.map