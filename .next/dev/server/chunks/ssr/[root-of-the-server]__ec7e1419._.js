...
"[project]/src/zen-garden-v2/plain-texture.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "createPlainTextureGenerator",
    ()=>createPlainTextureGenerator
]);
var __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__ = __turbopack_context__.i("[externals]/three [external] (three, esm_import, [project]/node_modules/three)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
`;
function createPlainTextureGenerator(renderer, plainSize, tileSize, gravelColorMap) {
    const renderTarget = new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["WebGLRenderTarget"](TEXTURE_RESOLUTION, TEXTURE_RESOLUTION, {
    ...
    const material = new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["ShaderMaterial"]({
        ...
        uniforms: {
            gravelColorMap: {
                value: gravelColorMap
            },
            plainSize: {
                value: new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Vector2"](plainSize.x, plainSize.y)
            },
            tileSize: {
                value: tileSize
            },
            strokeData: {
                value: strokeDataArray
            },
            circleCenters: {
                value: circleCentersArray
            },
            strokePoints: {
                value: strokePointsArray
            },
            strokeCount: {
                value: 0
            }
    ...
    function update(strokes) {
        ...
        for(let i = 0; i < count; i++){
            ...
            if (path.type === "circle") {
                ...
                // Sample the curve
                const curvePoints = path.points.map((p)=>new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Vector3"](p.x + position.x, p.y + position.y, 0));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/rxjs/dist/cjs/index.js [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__ = __turbopack_context__.i("[externals]/three [external] (three, esm_import, [project]/node_modules/three)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2d$texture$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/zen-garden-v2/plain-texture.ts [ssr] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2d$texture$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__,
...
[__TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2d$texture$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$rake$2d$stroke$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$vector2$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
class ZenGardenPlain {
    ...
    constructor(encoded, renderer){
        ...
        this.pendingStrokes = [];
        this._size = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$vector2$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["Vector2"](encoded.size);
        ...
        this.object = new __TURBOPACK__imported__module__$5b$externals$5d2f$three__$5b$external$5d$__$28$three$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$three$29$__["Mesh"](geometry, this.material);
    ...
    loadGravelTexture() {
        ...
        loader.load("/textures/gravel/color.jpg", (texture)=>{
            ...
            this.textureGenerator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2d$texture$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["createPlainTextureGenerator"])(this.renderer, {
                x: this._size.x,
                y: this._size.y
            }, TILE_SIZE, texture);
...
class ZenGardenScene {
    ...
    constructor(encoded, renderer){
        ...
        // Plain
        this.plain = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$zen$2d$garden$2d$v2$2f$plain$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["ZenGardenPlain"](encoded.plain, renderer);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec7e1419._.js.map