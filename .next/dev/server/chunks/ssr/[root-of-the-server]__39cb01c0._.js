...
class ZenGardenPlain {
    ...
    constructor(encoded, $rakes, renderer){
        ...
        const $throttledCameraPosition = $cameraPosition.pipe(throttleTime(100), scan((acc, curr)=>{
            ...
            prev: null,
            emit: null
        }), filter((x)=>x.emit !== null), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["map"])((x)=>x.emit));
        this.geometryNode = new AdaptivePlaneGeometryNode(context, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39cb01c0._.js.map